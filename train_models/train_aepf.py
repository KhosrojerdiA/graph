...
trained_models_path = f"{main_path}/edge_performance_dataset"
...
) = retrieval_v3(data, data_name, graph_model, min_number_edges, main_seed)


#________________________________________________________________________________________________________________________

simplified_performance = load_edge_performance_change_position(graph_model, data_name, trained_models_path)
