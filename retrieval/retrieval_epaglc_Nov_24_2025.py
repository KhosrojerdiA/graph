...
def retrieval_v4(data, data_name, graph_model, min_number_edges, embeddings_save_dir, embedding_version, main_seed):
    ...
    with torch.no_grad():
        ...
        h_iso = output[0] if isinstance(output, tuple) else output
        selected_node_embeddings = h_iso[selected_nodes]
